...
# =====================
# Phase 4: Minimal FP16 service for Qwen2-1.5B (Windows + CUDA)
...
def _startup():
    ...
    model = AutoModelForCausalLM.from_pretrained(
        MODEL_ID,
        torch_dtype=DTYPE,   # transformers prints a deprecation warning, but works
        device_map="cuda",
...
async def generate(req: GenerateReq):
    ...
    try:
        ...
        # GPU OOM should be returned as a structured error
        return {
            "error": "OOM",
            "detail": str(e)[:400],
            "ctx_len": ctx_len,
...
async def generate_stream(req: GenerateReq, request: Request):
    ...
    # We measure queue_wait as 0 under fast reject; include it for schema completeness
    queue_wait_s = 0.0
